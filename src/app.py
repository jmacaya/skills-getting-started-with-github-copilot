...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["laura@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Drama Society": {
        "description": "Practice acting, stagecraft, and theatrical performances",
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["zara@mergington.edu", "alex@mergington.edu"]
    }
}
